...
const GeminiChat = ({ onClose }) => {
  ...
  return (
    ...
    >
        ...
        {messages.map((msg, i) => (
          <View
            ...
            style={{
              ...
              backgroundColor: msg.from === 'you' ? theme.colors.primary : theme.colors.secondary,
              padding: 12,
              borderRadius: 18,
          ...
          >
            <Text style={{ color: theme.colors.black, fontSize: 15, fontFamily: theme.fonts.type.medium }}>
              {msg.text}
            </Text>
          </View>
        ))}
      ...
      {/* Suggestions */}
      <View style={{ paddingHorizontal: 12, paddingBottom: 8, backgroundColor: theme.colors.white }}>
        <FlatList
          data={SUGGESTIONS}
          horizontal
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              disabled={loading}
            >
              <Text style={{ color: theme.colors.black, fontFamily: theme.fonts.type.medium }}>{item}</Text>
            </TouchableOpacity>
          )}
        />
      </View>
